    ...
    return (
        <>
            <div className="fixed bottom-0 left-6 hidden flex-col items-center justify-center gap-10 p-2 pb-0 md:flex">
                ...
                <motion.a aria-label='linkedin' rel='noreferrer' target='_blank' href="https://www.linkedin.com/in/toby-salau-37b20723a/" whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }}><FiLinkedin className='text-lg text-white hover:text-primaryGreen' /></motion.a>
