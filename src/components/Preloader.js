    ...
    return (
        <motion.div animate={{ y: ["0%", "-100%"], transition: { duration: 1, delay: 8 } }} className="fixed top-0 left-0 w-screen h-screen bg-black grid place-item-center z-40">
            <div className="flex items-center justify-center space-x-4">
                <motion.img animate={{ x: [-20, 0], opacity: [0, 1] }} src="https://res.cloudinary.com/db1nlq5lv/image/upload/v1663155819/logo_zg9btl.png" alt="oluwatobi salau" className='w-14' />
