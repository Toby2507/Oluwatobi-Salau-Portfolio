    ...
    return (
        <motion.ul variants={variants} className='flex flex-col gap-3 items-center'>
            ...
            <motion.li variants={itemsVariants}>
                <a href="https://drive.google.com/file/d/1keiTTMZvGQU3-fk92013AY6gvrrAiJUu/view?usp=sharing" rel='noreferrer' target='_blank' download="oluwatobi's resume" aria-label='resume'><FancyButton text='resume' /></a>
            </motion.li>
        </motion.ul>
    )
}
